                ...
                <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <span id="store_image" class="image-preview"></span>
                        </div>
                    </div>
                    <br />
...
<div id="confirmModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 align="center" style="margin:0;">Are you sure you want delete this user ? </h4>
            </div>
        ...
        $(document).on('click', '.edit', function(){
            ...
            $.ajax({
                ...
                success:function(html){
                    ...
                    $('#store_image').html("<img src={{ URL::to('/') }}/images/" + html.data.image + " width='70' class='img-thumbnail image-preview' />");
